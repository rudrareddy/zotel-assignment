...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Edit Room Type for {{$roomType->name}}</li>
                </ol>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{url('admin/room-types/'.$roomType->id)}}" method="POST" enctype="multipart/form-data">
                      @csrf
                        {{ method_field('PATCH') }}
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="name" id="formrow-password-input"  value="{{$roomType->name}}">
                                     @if ($errors->has('name'))
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"  name="max_adults" id="formrow-password-input"  value="{{$roomType->max_adults}}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"  name="total_rooms" id="formrow-password-input"  value="{{$roomType->total_rooms}}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control" id="">{{$roomType->description}}</textarea>
